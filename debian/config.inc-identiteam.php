...
array(
    ...
    // Mail parameters
    'mail' => array(
        'domain' => '',                          // Id necessary, you can specify a domain to add after the login name to search
    ...
    // LDAP parameters
    'ldap' => array(
        'server' => \ConfigIgestisGlobalVars::LDAP_URIS,                    // Your LDAP server address
        ...
        'domain' => \ConfigIgestisGlobalVars::LDAP_USERS_OU,                   // LDAP Domain
